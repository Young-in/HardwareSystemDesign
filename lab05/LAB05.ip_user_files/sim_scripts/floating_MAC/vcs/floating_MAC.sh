...
#
# Generated by Vivado on Tue Apr 09 17:10:36 KST 2019
# SW Build 2405991 on Thu Dec  6 23:36:41 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: floating_MAC.sh [-help]
# usage: floating_MAC.sh [-lib_map_path]
# usage: floating_MAC.sh [-noclean_files]
# usage: floating_MAC.sh [-reset_run]
#
...
# executing this script. Please type 'floating_MAC.sh -help' for more information.
#
...
# Script info
echo -e "floating_MAC.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../LAB05.srcs/sources_1/ip/floating_MAC/sim/floating_MAC.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_MAC -o floating_MAC_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_MAC_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./floating_MAC.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/csehome/dhsodhao52/LAB05/LAB05.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key floating_MAC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc floating_MAC_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./floating_MAC.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: floating_MAC.sh [-help]\n\
Usage: floating_MAC.sh [-lib_map_path]\n\
Usage: floating_MAC.sh [-reset_run]\n\
Usage: floating_MAC.sh [-noclean_files]\n\n\
